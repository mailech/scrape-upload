...
const DEFS = {
    ...
    oftSubject:         { accessor: 'oftSubject',                        id: 'oftSubjectId',                  name: 'subjectName' },
    oftThematicArea:    { accessor: 'oftThematicArea',                   id: 'oftThematicAreaId',             name: 'thematicAreaName' },
    discipline:         { accessor: 'discipline',                        id: 'disciplineId',                  name: 'disciplineName' },
};
